...
<div class="w3-display-container"> 
    ...
    <button class="w3-button" > <img src="<?php echo $product_array[$key]["image"]; ?>" class="w3-grayscale-min" style="width:100%"> </button>
    </form>			<div class="product-tile-footer">
      ...
      <form method="post" action="index.php?action=add&types=<?php echo $product_array[$key]["types"]?>&code=<?php echo $product_array[$key]["code"]; ?>">
            ...
            <input type="submit" value="Add to Cart" class="btn btn-primary btnAddAction" style="width: 70%;height: 5.5%"></div>
			   </div>
			</form>
      </div>
</div>
