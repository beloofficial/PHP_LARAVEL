...
<body>
    ...
    <div class="w3-container">
      ...
      <p><input class="w3-input w3-padding-16 w3-border" type="file"  placeholder="image" required name="image"></p>



        <p><button class="w3-btn w3-round-xlarge w3-button w3-border w3-hover-green w3-black" type="submit">Add</button></p>
        <input class="w3-button w3-black w3-round-xlarge w3-border w3-hover-red" type="button" value="Back" OnClick="location.href='action_page.php'">
      </form>
    </div>
</body>
</html>
