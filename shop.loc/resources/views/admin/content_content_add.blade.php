<div class="wrapper container-fluid">
	...
	<div class="form-group">
		...
		<div class="col-xs-8">
			{!! Form::text('name',old('name'),['class' => 'form-control','placeholder'=>'Введите название продукта'])!!}
		</div>
	...
	<div class="form-group">
	     ...
	     <div class="col-xs-8">
		 	{!! Form::text('types', old('types'), ['class' => 'form-control','placeholder'=>'Введите тип продукта']) !!}
		 </div>
    </div>
    ...
    <div class="form-group">
	     ...
	     <div class="col-xs-8">
		 	{!! Form::text('code', old('code'), ['class' => 'form-control','placeholder'=>'Введите код продукта']) !!}
		 </div>
    </div>
    ...
    <div class="form-group">
	     ...
	     <div class="col-xs-8">
		 	{!! Form::textarea('text', old('text'), ['id'=>'editor','class' => 'form-control','placeholder'=>'Введите описание продукта']) !!}
		 </div>
    </div>
