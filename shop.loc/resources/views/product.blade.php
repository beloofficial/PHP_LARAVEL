...
<div class="container ">
  ...
  @if(auth()->check())
    <form method="post" action="{{ route('comment.add') }}">
      ...
      {!! Form::textarea('comment_body', old('comment_body'), ['id'=>'editor','class' => 'md-textarea form-control','rows'=>3,'placeholder'=>'Напишите ваш комментарий сюда']) !!}
     </div>
    </div>
  ...
  @else
    <h4><a href="{{route('register')}}">Register</a> or <a href="{{route('login')}}">Sign In</a> to leave comment</h4>
@endif
