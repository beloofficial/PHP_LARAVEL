  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar">
    <div class="container">
      <a href="#" class="navbar-brand waves-effect">
        <strong class="blue-text">Ram-Os</strong>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li>
            <a href="{{route('about')}}" class="nav-link waves-effect">About</a>
          </li>
  ...
  <div id="carousel-ex" class="carousel slide carousel-fade pt-4" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active">
          <div class="view" style="background-image: url({{asset('back.jpeg')}});
    ...
    <div class="container">
       ...
       mdb-color lighten-3 mt-3 mb-5">
        ...
        <div class="collapse navbar-collapse" id="nextNav">
          ...
          <ul class="navbar-nav mr-auto">
            @if($category == 'all')
                <li class="nav-item active">
                        <a href="{{route('products',['category'=>'all'])}}" class="nav-link">Все</a>
                </li>
            @else
                <li class="nav-item">
                        <a href="{{route('products',['category'=>'all'])}}" class="nav-link">Все</a>
            ...
            @foreach($types as $k=>$type)
                @if($type['types'] == $category)
                    <li class="nav-item active">
                        <a href="{{route('products',['category'=>$type['types']])}}" class="nav-link">{{$type['types']}}</a>
                    </li>
                @else
                    <li class="nav-item ">
                      <a href="{{route('products',['category'=>$type['types']])}}" class="nav-link">{{$type['types']}}</a>
      ...
      <section class="text-center mb-4">
        <div class="row wow fadeIn">
         ...
         @if($category == "all" or $product->types == $category)
