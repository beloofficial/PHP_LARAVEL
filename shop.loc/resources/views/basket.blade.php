              ...
              <tr id="row_{{$product->id}}" >
                <th>
                  <div id="img-card" class="view rounded">
                    <a href="{{route('product',['code'=>$product['attributes']->code])}}" class="image_st"> <img  src="{{asset('assets/img/products/'.$product['attributes']->image)}}" class = "card-img-top"alt="Lacoste" alt="" style="width: 150px; height: 150px;">   

                  </div>
                  </th>
                <th>

                 <a href="{{route('product',['code'=>$product['attributes']->code])}}" class="name_st"> <p style="font-size: 20px;font-family: 'Montserrat', sans-serif;">{{$product->name}}</p> </a>
